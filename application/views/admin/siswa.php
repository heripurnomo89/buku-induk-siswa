    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <div class="search-field d-none d-md-block">
                <form class="d-flex align-items-center h-100" action="<?= base_url('admin/Siswa'); ?>" method="post">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/ibu'); ?>">Ibu</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title pb-3">
                                    <a href="<?= base_url('admin/addSiswa'); ?>">
                                ...
                                <table class="table table-responsive table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center">
                                            ...
                                            <td><?= $s->email; ?></td>
                                            <td><?= $s->bansos; ?></td>
                                            <td><a href="<?= base_url('admin/editSiswa/'); ?><?= $s->idsiswa; ?>"
                                                    class="badge badge-info">
                                                    <i class="mdi mdi-lead-pencil"></i> edit</a>
                                                <a href="<?= base_url('admin/delSiswa/'); ?><?= $s->idsiswa; ?>"
