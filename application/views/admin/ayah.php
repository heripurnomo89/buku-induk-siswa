    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <div class="search-field d-none d-md-block">
                <form class="d-flex align-items-center h-100" action="<?= base_url('admin/ayah'); ?>" method="post">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title pb-3">
                                    <a href="<?= base_url('admin/addAyah'); ?>">
                                        <button type="button" class="btn btn-outline-primary btn-rounded">
                                            <i class="mdi mdi-plus"></i> Tambah Data Ayah
                                        </button>
                                    </a>
                                </h5>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= ++$start; ?></td>
                                            <td><?= $a->nama; ?></td>
                                            <td><?= date('d/m/Y', strtotime($a->lahir)); ?></td>
                                            <td><?= $a->pendidikan; ?></td>
                                            <td><?= $a->pekerjaan; ?></td>
                                            <td><?= $a->penghasilan; ?></td>
                                            <td><?= $a->nmSiswa; ?></td>
                                            <td><a href="<?= base_url('admin/editAyah/'); ?><?= $a->idayah; ?>"
                                                    class="badge badge-info">
                                                    <i class="mdi mdi-lead-pencil"></i> edit</a>
                                                <a href="<?= base_url('admin/delAyah/'); ?><?= $a->idayah; ?>"
