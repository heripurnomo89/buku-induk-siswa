    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
            <div class="search-field d-none d-md-block">
                <form class="d-flex align-items-center h-100" action="<?= base_url('admin/wali'); ?>" method="post">
                    <div class="input-group">
                        ...
                        <input class="btn btn-sm btn-gradient-primary " type="submit" value="Cari" name="submit">
                    </div>
                </form>
            </div>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= ++$start; ?></td>
                                            <td><?= $w->nama; ?></td>
                                            <td><?= date('d/m/Y', strtotime($w->lahir)); ?></td>
                                            <td><?= $w->pendidikan; ?></td>
                                            <td><?= $w->pekerjaan; ?></td>
                                            <td><?= $w->penghasilan; ?></td>
                                            <td><?= $w->nmSiswa; ?></td>
                                            <td><a href="<?= base_url('admin/editWali/'); ?><?= $w->idwali; ?>"
                                                    class="badge badge-info">
                                                    <i class="mdi mdi-lead-pencil"></i> edit</a>
                                                <a href="<?= base_url('admin/delWali/'); ?><?= $w->idwali; ?>"
